...
$stmt = db_prepare(
    $conn,
    'INSERT INTO evaluations (scholar_id, program_type, course_year, assigned_area, supervisor_name, month_label, ratings_json, total_score, average_score, recommendation)
     VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)'
);
